sap.ui.define([
    ...
    return PropertyEditor.extend( "abb.views.customComplete.customCompletePlugin.customCompletePlugin.builder.PropertyEditor" ,{

		constructor: function(sId, mSettings){
			PropertyEditor.apply(this, arguments);
			
			this.setI18nKeyPrefix("customComponentListConfig.");
			this.setResourceBundleName("abb.views.customComplete.customCompletePlugin.customCompletePlugin.i18n.builder");
			this.setPluginResourceBundleName("abb.views.customComplete.customCompletePlugin.customCompletePlugin.i18n.i18n");
		},
		...
		addPropertyEditorContent: function(oPropertyFormContainer){
			...
			this.addInputField(oPropertyFormContainer, "keyCheckCycleTimeComplete", oData);
			this.addInputField(oPropertyFormContainer, "keyCompleteSFC", oData);
